...
# Intersect#eval_prog: #<NameError: undefined local variable or method `y1' for Point.new(2.5,1.5):Point  Did you mean?  y                 @y> ["/shared/submission/hw.rb:173:in `intersectWithSegmentAsLineResult'", "/shared/submission/hw.rb:69:in `intersectLineSegment'", "/shared/submission/hw.rb:321:in `intersect'", "/shared/submission/hw.rb:402:in `eval_prog'", "/shared/submission/hw.rb:401:in `eval_prog'", "/shared/submission/hw.rb:401:in `eval_prog'"] [error]
# intersect_methods(Point#intersect): #<NameError: undefined local variable or method `y1' for Point.new(1.0,1.0):Point  Did you mean?  y                 @y> ["/shared/submission/hw.rb:173:in `intersectWithSegmentAsLineResult'", "/shared/submission/hw.rb:69:in `intersectLineSegment'", "/shared/submission/hw.rb:321:in `intersect'", "/shared/submission/hw.rb:325:in `intersectPoint'", "/shared/submission/hw.rb:137:in `intersect'"] [error]
# intersect_methods(Point#intersectLineSegment): #<NameError: undefined local variable or method `y1' for Point.new(1.0,1.0):Point  Did you mean?  y                 @y> ["/shared/submission/hw.rb:173:in `intersectWithSegmentAsLineResult'", "/shared/submission/hw.rb:69:in `intersectLineSegment'"] [error]
# intersect_methods(LineSegment#intersect): #<NameError: undefined local variable or method `y1' for Point.new(1.0,1.0):Point  Did you mean?  y                 @y> ["/shared/submission/hw.rb:173:in `intersectWithSegmentAsLineResult'", "/shared/submission/hw.rb:69:in `intersectLineSegment'", "/shared/submission/hw.rb:321:in `intersect'"] [error]
# intersect_methods(LineSegment#intersectPoint): #<NameError: undefined local variable or method `y1' for Point.new(1.0,1.0):Point  Did you mean?  y                 @y> ["/shared/submission/hw.rb:173:in `intersectWithSegmentAsLineResult'", "/shared/submission/hw.rb:69:in `intersectLineSegment'", "/shared/submission/hw.rb:321:in `intersect'", "/shared/submission/hw.rb:325:in `intersectPoint'"] [error]
# intersect_methods(Line#intersect): #<NameError: undefined local variable or method `y1' for Point.new(1.0,5.0):Point  Did you mean?  y                 @y> ["/shared/submission/hw.rb:173:in `intersectWithSegmentAsLineResult'", "/shared/submission/hw.rb:69:in `intersectLineSegment'", "/shared/submission/hw.rb:321:in `intersect'", "/shared/submission/hw.rb:329:in `intersectLine'", "/shared/submission/hw.rb:203:in `intersect'"] [error]
# intersect_methods(Line#intersectLineSegment): #<NameError: undefined local variable or method `y1' for Point.new(1.0,5.0):Point  Did you mean?  y                 @y> ["/shared/submission/hw.rb:173:in `intersectWithSegmentAsLineResult'", "/shared/submission/hw.rb:69:in `intersectLineSegment'"] [error]
# intersect_methods(LineSegment#intersect): #<NameError: undefined local variable or method `y1' for Point.new(1.0,5.0):Point  Did you mean?  y                 @y> ["/shared/submission/hw.rb:173:in `intersectWithSegmentAsLineResult'", "/shared/submission/hw.rb:69:in `intersectLineSegment'", "/shared/submission/hw.rb:321:in `intersect'"] [error]
# intersect_methods(LineSegment#intersectLine): #<NameError: undefined local variable or method `y1' for Point.new(1.0,5.0):Point  Did you mean?  y                 @y> ["/shared/submission/hw.rb:173:in `intersectWithSegmentAsLineResult'", "/shared/submission/hw.rb:69:in `intersectLineSegment'", "/shared/submission/hw.rb:321:in `intersect'", "/shared/submission/hw.rb:329:in `intersectLine'"] [error]
# intersect_methods(VerticalLine#intersect): #<NameError: undefined local variable or method `y1' for Point.new(2.0,2.0):Point  Did you mean?  y                 @y> ["/shared/submission/hw.rb:173:in `intersectWithSegmentAsLineResult'", "/shared/submission/hw.rb:69:in `intersectLineSegment'", "/shared/submission/hw.rb:321:in `intersect'", "/shared/submission/hw.rb:333:in `intersectVerticalLine'", "/shared/submission/hw.rb:256:in `intersect'"] [error]
# intersect_methods(VerticalLine#intersectLineSegment): #<NameError: undefined local variable or method `y1' for Point.new(2.0,2.0):Point  Did you mean?  y                 @y> ["/shared/submission/hw.rb:173:in `intersectWithSegmentAsLineResult'", "/shared/submission/hw.rb:69:in `intersectLineSegment'"] [error]
# intersect_methods(LineSegment#intersect): #<NameError: undefined local variable or method `y1' for Point.new(2.0,2.0):Point  Did you mean?  y                 @y> ["/shared/submission/hw.rb:173:in `intersectWithSegmentAsLineResult'", "/shared/submission/hw.rb:69:in `intersectLineSegment'", "/shared/submission/hw.rb:321:in `intersect'"] [error]
# intersect_methods(LineSegment#intersectVerticalLine): #<NameError: undefined local variable or method `y1' for Point.new(2.0,2.0):Point  Did you mean?  y                 @y> ["/shared/submission/hw.rb:173:in `intersectWithSegmentAsLineResult'", "/shared/submission/hw.rb:69:in `intersectLineSegment'", "/shared/submission/hw.rb:321:in `intersect'", "/shared/submission/hw.rb:333:in `intersectVerticalLine'"] [error]
# intersect_methods(LineSegment#intersect): #<NameError: undefined local variable or method `y1' for Point.new(5.0,7.0):Point  Did you mean?  y                 @y> ["/shared/submission/hw.rb:173:in `intersectWithSegmentAsLineResult'", "/shared/submission/hw.rb:69:in `intersectLineSegment'", "/shared/submission/hw.rb:321:in `intersect'", "/shared/submission/hw.rb:68:in `intersectLineSegment'", "/shared/submission/hw.rb:321:in `intersect'"] [error]
